...
const Order = () => {
  return (
    <div><section className="text-pink-400 bg-gray-900 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">Codewears.com</h2>
            <h1 className="text-white text-3xl title-font font-medium mb-4">Order Id :#94040</h1>
            <div className="flex mb-4">
              <a className="flex-grow text-pink-400 border-b-2 border-pink-500 py-2 text-lg px-1">Description</a>
            ...
            <div className="flex border-t border-gray-800 py-2">
              <span className="text-gray-500">Waer the code xl red</span>
              <span className="ml-auto text-white">Medium</span>
              <span className="ml-auto text-white">100</span>
            </div>
            <div className="flex border-t border-b mb-6 border-gray-800 py-2">
              <span className="text-gray-500">Waer the code xl white</span>
